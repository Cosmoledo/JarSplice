...
public class ClassPanel extends JPanel implements ActionListener {
	...
	public ClassPanel() {
		...
		this.add(this.getMainClassBox(), "First");
		this.vmArgBox = this.getVmArgBox();
		this.add(this.vmArgBox, "Center");
	...
	private JPanel getVmArgBox() {
		...
		label2.setText(String.format("<html><div style=\"width:%dpx;\">%s</div><html>", new Object[]{Integer.valueOf(300),
		...
		label3.setText(String.format("<html><div style=\"width:%dpx;\">%s</div><html>", new Object[]{Integer.valueOf(300),
